...
//                newsInfo.setAbstr(solrDocument.getFieldValue("abstact").toString());
    ...
    public static void main(String[] args) {
        ...
        final String solrUrl = "http://223.3.93.101:8983/solr/eventlines";
        HttpSolrClient solrServer = new HttpSolrClient.Builder(solrUrl)
                .withConnectionTimeout(10000)
                .withSocketTimeout(60000)
                .build();
        searchEventLineDao.httpSolrClientEventLines = solrServer;
        SearchEventLineDao searchEventLineDao1=new SearchEventLineDao();
        System.out.println(searchEventLineDao.eventLineKeywords("b0b8e880-d446-11e8-a167-ac1f6b2420ac")[0]);
